  ...
  return(
    <main className="fade-in">
      <div className="legal-flex">
        ...
        <div className="legal">
          <div className="legal-sub-header">PERSONAL INFORMATION WE COLLECT</div>
          ...
          <div className="legal-body">
            <div className="legal-body-header">Cookies</div>
            These are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit http://www.allaboutcookies.org.
          </div>
          <div className="legal-body">
            <div className="legal-body-header">Log Files</div>
          ...
          <div className="legal-body">
            <div className="legal-body-header">Purchases</div>
        ...
        <div className="legal">
          <div className="legal-sub-header">DO NOT TRACK</div>
          <div className="legal-body">
            Please note that we do not alter our Site's data collection and use practices when we see a Do Not Track signal from your browser.
          </div>
        </div>
        <div className="legal">
          <div className="legal-sub-header">YOUR RIGHTS</div>
          <div className="legal-body">
        ...
        <div className="legal">
          <div className="legal-sub-header">DATA RETENTION</div>
          <div className="legal-body">
            When you place an order through the Site, we will maintain your Order Information for our records unless and until you ask us to delete this information.
          </div>
        </div>
        <div className="legal">
          <div className="legal-sub-header">MINORS</div>
          <div className="legal-body">
            The Site is not intended for individuals under the age of 18.
          </div>
        </div>
        <div className="legal">
          <div className="legal-sub-header">CHANGES</div>
          <div className="legal-body">
        ...
        <div className="legal">
          ...
          <div className="legal-body">
            For information about your privacy, terms, or you want to make a complaint, e-mail us: <a href="mailto:admin@d2r-api.com">admin@d2r-api.com</a>
          </div>
        </div>
      </div>
    </main>
